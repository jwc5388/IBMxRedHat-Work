...
from keras.layers import Conv2D, MaxPooling2D, Dropout, Flatten, Dense, BatchNormalization, Activation, Input
...
maxpool1 = MaxPooling2D()(act1)
drop1 = Dropout(0.3)(maxpool1)

conv2 = Conv2D(filters = 128, kernel_size=(3,3), padding='same')(drop1)
batch2 = BatchNormalization()(conv2)
act2 = Activation('relu')(batch2)
maxpool2 = MaxPooling2D()(act2)
drop2 = Dropout(0.3)(maxpool2)

conv3 = Conv2D(filters=128, kernel_size=(3,3), padding='same')(drop2)
batch3 = BatchNormalization()(conv3)
act3 = Activation('relu')(batch3)
maxpool3 = MaxPooling2D()(act3)
