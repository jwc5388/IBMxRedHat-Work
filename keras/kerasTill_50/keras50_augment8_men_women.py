...
# 5. 증강 실행
x_aug_0 = datagen.flow(x_aug_0, y_aug_0, batch_size=augment_0, shuffle=False).next()[0]
x_aug_1 = datagen.flow(x_aug_1, y_aug_1, batch_size=augment_1, shuffle=False).next()[0]
