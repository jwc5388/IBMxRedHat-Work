...
from keras.layers import Dense, Dropout, BatchNormalization, LSTM, Conv1D, Flatten
...
model = Sequential([
    Conv1D(filters = 64, kernel_size = 2, padding = 'same', input_shape = (25,1), activation = 'relu'),
