...
from keras.layers import LSTM, Dense, Dropout, BatchNormalization, Conv1D, Flatten
...
# exit()
# --- 7. 모델 정의 ---   #input_shape = (144,13)
model = Sequential([
    Conv1D(64, kernel_size = 2, input_shape=(x.shape[1], x.shape[2]), padding = 'same'),
...
# ✅ submission 저장 완료: /workspace/TensorJae/Study25/_save/jena/20250623_033845/submission.csv
#                  Date Time  wd (deg)
# 420407 2016-12-31 00:10:00     225.0
# 420408 2016-12-31 00:20:00     225.0
# 420409 2016-12-31 00:30:00     225.0
# 420410 2016-12-31 00:40:00     225.0
# 420411 2016-12-31 00:50:00     225.0