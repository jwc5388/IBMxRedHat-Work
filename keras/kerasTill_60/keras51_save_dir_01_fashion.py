...
x_augmented = datagen.flow(
    ...
    shuffle = False,
    save_to_dir= '/workspace/TensorJae/Study25/_data/_save_img/01_fashion/', 
).next()[0]
...
mcp = ModelCheckpoint(
    ...
    mode = 'auto',
    save_best_only = True,
    filepath = mcp_path + 'keras50_fashion.h5'
)
...
# ✅ loss: 0.3151874542236328
# ✅ acc: 0.8901000022888184
# ⏱️ time: 2415.9477713108063