...
# --- 7. 모델 정의 ---
model = Sequential([
    Bidirectional(LSTM(64, return_sequences=False, dropout=0.2), input_shape=(x.shape[1], x.shape[2])),
...
# ✅ submission 저장 완료: /workspace/TensorJae/Study25/_save/jena/20250620_074546/submission.csv
