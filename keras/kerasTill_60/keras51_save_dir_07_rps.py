...
# ✅ 데이터 불러오기 + 정규화
start = time.time()
x = np.load(np_path + 'keras46_rps_x_train.npy') 
...
x_augmented = datagen.flow(
    ...
    shuffle = False,
    save_to_dir= '/workspace/TensorJae/Study25/_data/_save_img/07_rps/', 
).next()[0]
...
# 모델 학습 완료. 소요시간: 341.66초
# 최종 훈련 데이터 평가 - Loss: 0.1988, Accuracy: 1.0000