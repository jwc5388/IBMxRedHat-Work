...
#1 체크포인트로 확인
# model = load_model(path + 'keras27_mcp3.h5', custom_objects={'mse': keras.losses.MeanSquaredError()})
model = load_model(path + 'keras27_3_save_model.h5', custom_objects={'mse': keras.losses.MeanSquaredError()})
#2 save_model꺼 확ㅇ니
#이거 초기 가중치 - 그래서 구림
...
# loss: 11.466863632202148
# 4/4 ━━━━━━━━━━━━━━━━━━━━ 0s 20ms/step
# r2 score 0.8436346395187323