...
# =================================================
# for max score deleted columns: ['mean radius', 'mean texture', 'mean perimeter', 'mean area', 'mean smoothness', 'mean compactness', 'mean concavity', 'mean symmetry', 'mean fractal dimension', 'radius error', 'perimeter error', 'smoothness error', 'concave points error', 'symmetry error', 'fractal dimension error', 'worst smoothness', 'worst compactness', 'worst symmetry', 'worst fractal dimension']
# max accuracy score: 0.956140350877193
# 삭제할 컬럼수: 11 개
