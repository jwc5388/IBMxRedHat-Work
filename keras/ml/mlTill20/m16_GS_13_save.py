...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score', ascending=True).to_csv(path + 'm15_gs_otto_csv_results.csv')  #gs = gridsearch



path = '/workspace/TensorJae/Study25/_save/m15_cv_results/'
joblib.dump(model.best_estimator_, 'm16_13_best_model.joblib')
