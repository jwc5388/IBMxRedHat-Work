...
model = HalvingGridSearchCV(xgb, parameters, cv = kfold, 
                            ...
                            aggresive_elimination = True,  #false default
...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score', ascending=True).to_csv(path + 'm20_00_csv_results.csv')  #gs = gridsearch

joblib.dump(model.best_estimator_, 'm20_00_best_model.joblib')
