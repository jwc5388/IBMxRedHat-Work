...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score', ascending=True).to_csv(path + 'm15_gs_santander_csv_results.csv')  #gs = gridsearch




path = '/workspace/TensorJae/Study25/_save/m15_cv_results/'
joblib.dump(model.best_estimator_, 'm16_12_best_model.joblib')



# best score: 0.9174875
# model.score: 0.9173
# accuracy score: 0.9173
# best accuracy score: 0.9173
# time: 925.01 seconds