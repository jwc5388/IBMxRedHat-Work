...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score', ascending=True).to_csv(path + 'm18_rs_12_csv_results.csv')  #gs = gridsearch

joblib.dump(model.best_estimator_, 'm18_12_best_model.joblib')
