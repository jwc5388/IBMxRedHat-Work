...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score', ascending=True).to_csv(path + 'm20_10_csv_results.csv')  #gs = gridsearch

joblib.dump(model.best_estimator_, 'm20_10_best_model.joblib')



# best score: 0.794295518495642
# model.score: 0.897025033777097
# accuracy score: 0.897025033777097
# best accuracy score: 0.897025033777097
# time: 604.74 seconds