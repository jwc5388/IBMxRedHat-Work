...
# x, y 불러오기
x_train = np.load(basepath + '_save/rps/keras_rps_x_train.npy')
x_test = np.load(basepath + '_save/rps/keras_rps_x_test.npy')
y_train = np.load(basepath + '_save/rps/keras_rps_y_train.npy')
y_test = np.load(basepath + '_save/rps/keras_rps_y_test.npy')


x = np.concatenate([x_train,x_test], axis=0)

print(x.shape)  #(2048, 150, 150, 3)
# exit()
