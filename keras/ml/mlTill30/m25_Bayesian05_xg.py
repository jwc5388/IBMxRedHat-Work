...
def xgb_cv(n_estimators, learning_rate, max_depth, min_child_weight, gamma, 
    ...
    model.fit(
        ...
        eval_metric='rmse',  # 또는 'mae', 'logloss', 'error' 등
        callbacks=[
...
# ⏱ Optimization Time: 23.7 seconds
# 🚀 Best Parameters Found:
# {'target': 0.8042358773425258, 'params': {'n_estimators': 276.614821771048, 'learning_rate': 0.1, 'max_depth': 10.0, 'min_child_weight': 1.0, 'subsample': 1.0, 'gamma': 0.0, 'colsample_bytree': 1.0, 'colsample_bylevel': 0.5, 'max_bin': 243.0487341323551, 'reg_lambda': 16.59222437806555, 'reg_alpha': 4.60091058897095}}