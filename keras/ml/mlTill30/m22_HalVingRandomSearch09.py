...
model = HalvingRandomSearchCV(xgb, parameters, cv = kfold, 
                            ...
                            min_resources=50, # 1 iter 때의 최소 훈련 행의 갯수
...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score', ascending=True).to_csv(path + 'm22_09_csv_results.csv')  #gs = gridsearch

joblib.dump(model.best_estimator_, 'm22_09_best_model.joblib')
# best score: 0.8511111111111112
# model.score: 0.9722222222222222
# accuracy score: 0.9722222222222222
# best accuracy score: 0.9722222222222222