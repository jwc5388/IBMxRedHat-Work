...
print(np.unique(y_train, return_counts=True)) #(array([0, 1]), array([143922, 143922]))
...
model.fit(x_train, y_train, epochs = 30, validation_split=0.2, batch_size=64)
...
# accuracy score: 0.779625
# f1 score: 0.6372601587393782