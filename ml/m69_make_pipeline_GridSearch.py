...
parameters = [
    {'randomforestclassifier__n_estimators' : [100,200], 'randomforestclassifier__max_depth': [5,6,10], 'randomforestclassifier__min_samples_leaf': [3,10]},
    {'randomforestclassifier__max_depth': [6,8,10,12], 'randomforestclassifier__min_samples_leaf': [3,5,7,10]},
    {'randomforestclassifier__min_samples_leaf':[3,5,7,9], 'randomforestclassifier__min_samples_split': [2,3,5,10]},
