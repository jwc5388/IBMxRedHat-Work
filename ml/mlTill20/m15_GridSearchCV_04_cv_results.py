...
path = '/Users/jaewoo000/Desktop/IBM:RedHat/Study25/_data/dacon/ddarung/'
...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score', ascending=True).to_csv(path + 'm15_gs_dacon_ddarung_csv_results.csv')  #gs = gridsearch
