...
def xgb_cv(n_estimators, learning_rate, max_depth, min_child_weight, gamma, 
    ...
    model = LGBMClassifier(
        **params, n_jobs=-3,early_stopping_rounds=1
    )
...
# ⏱ Optimization Time: 399.73 seconds
# 🚀 Best Parameters Found:
# {'target': 0.8169844861021331, 'params': {'n_estimators': 480.21312838176357, 'learning_rate': 0.08880630723540003, 'max_depth': 9.2273486505248, 'min_child_weight': 17.826915841649637, 'subsample': 0.9705284549608648, 'gamma': 0.4614942085446083, 'colsample_bytree': 0.9326050549781852, 'colsample_bylevel': 0.5710142624245369, 'max_bin': 253.90149375316736, 'reg_lambda': 10.581506613770863, 'reg_alpha': 7.7159648459030015}}