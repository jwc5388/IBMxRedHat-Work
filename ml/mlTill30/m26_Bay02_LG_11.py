...
# ⏱ Optimization Time: 116.36 seconds
# 🚀 Best Parameters Found:
# {'target': 0.9638888888888889, 'params': {'n_estimators': 380.20097720651125, 'learning_rate': 0.1, 'max_depth': 3.0, 'min_child_weight': 1.0, 'subsample': 1.0, 'gamma': 0.0, 'colsample_bytree': 0.5, 'colsample_bylevel': 0.5, 'max_bin': 29.2541728528675, 'reg_lambda': 20.63718024078141, 'reg_alpha': 0.01}}