...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score', ascending=True).to_csv(path1 +  'm22_06_results.csv')  #gs = gridsearch

joblib.dump(model.best_estimator_, path + 'm22_06_best_model.joblib')
