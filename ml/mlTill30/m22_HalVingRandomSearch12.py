...
model = HalvingRandomSearchCV(xgb, parameters, cv = kfold, 
                            ...
                            min_resources=30, # 1 iter 때의 최소 훈련 행의 갯수
...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score', ascending=True).to_csv(path + 'm22_12_csv_results.csv')  #gs = gridsearch

joblib.dump(model.best_estimator_, 'm22_12_best_model.joblib')




# best score: 0.9111111111111111
# model.score: 0.899575
# accuracy score: 0.899575
# best accuracy score: 0.899575
# time: 76.43 seconds


# best score: 0.9049382716049383
# model.score: 0.8995
# accuracy score: 0.8995
# best accuracy score: 0.8995
# time: 97.63 seconds